...
class AppsTab extends StatelessWidget {
  ...
  static const List<TvAppItem> _apps = [
    TvAppItem(
      ...
      appLink: 'https://play.google.com/store/apps/details?id=com.google.android.youtube.tv',
      color: Color(0xFFFF0000),
    ),
    TvAppItem(
      name: 'Netflix',
      icon: Icons.movie_filter_rounded,
      appLink: 'https://play.google.com/store/apps/details?id=com.netflix.ninja',
      color: Color(0xFFE50914),
    ),
    TvAppItem(
      name: 'Prime Video',
      icon: Icons.video_library_rounded,
      appLink: 'https://play.google.com/store/apps/details?id=com.amazon.amazonvideo.livingroom',
      color: Color(0xFF00A8E1),
    ),
    TvAppItem(
      name: 'Disney+',
      icon: Icons.star_rounded,
      appLink: 'https://play.google.com/store/apps/details?id=com.disney.disneyplus',
      color: Color(0xFF113CCF),
    ),
    TvAppItem(
      name: 'Plex',
      icon: Icons.dns_rounded,
      appLink: 'https://play.google.com/store/apps/details?id=com.plexapp.android',
      color: Color(0xFFE5A93B),
    ),
    TvAppItem(
      name: 'Spotify',
      icon: Icons.music_note_rounded,
      appLink: 'https://play.google.com/store/apps/details?id=com.spotify.tv.android',
      color: Color(0xFF1DB954),
    ),
    TvAppItem(
      name: 'Twitch',
      icon: Icons.live_tv_rounded,
      appLink: 'https://play.google.com/store/apps/details?id=tv.twitch.android.viewer',
      color: Color(0xFF9146FF),
    ),
    TvAppItem(
      name: 'Hulu',
      icon: Icons.slideshow_rounded,
      appLink: 'https://play.google.com/store/apps/details?id=com.hulu.livingroom',
